 ...
 * @author gilca
 */
public class JDAtualizarConsulta extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public JDAtualizarConsulta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
     ...
     * @param consulta
     */
    public JDAtualizarConsulta(java.awt.Frame parent, boolean modal, Consulta consulta) {
        super(parent, modal);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            JOptionPane.showMessageDialog(this, "Favor escolher o paciente "
                    + "que deseja marcar a consulta.");

        } else { //agendar a consulta - duh!

            Paciente paciente = (Paciente) this.jTablePaciente.getValueAt(selectedRow, 5);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDAtualizarConsulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            JDAtualizarConsulta dialog = new JDAtualizarConsulta(new javax.swing.JFrame(), true);
